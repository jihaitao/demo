...
#import "TudouMVListViewController.h"
#import "TudouMVManager.h"

@interface TudouMVListViewController ()

@end

@implementation TudouMVListViewController
...
- (void)viewDidLoad {
    ...
    TudouMVManager *manager = [[TudouMVManager alloc] init];
    [manager getMVList:urlString];
}
